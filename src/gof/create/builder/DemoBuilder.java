...
public class DemoBuilder {
    public static void main(String[] args) {
        SuperComputer superComputer = SuperComputer.Builder.builder("500T","100G").setGraphicsCardEnabled(true).setBlueToothEnabled(false).build();

        System.out.println(superComputer.getHDD());
        System.out.println(superComputer.getRAM());
        System.out.println(superComputer.isBlueToothEnabled());
